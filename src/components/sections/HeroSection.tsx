...
const HeroMap = dynamic(() => import("@/components/sections/MapSection"), {
  ssr: false,
  loading: () => <div className="h-[180px] w-full bg-primary/5 animate-pulse rounded-2xl" />,
});
    ...
    <section className="relative flow-root bg-gradient-to-br from-secondary via-secondary to-primary/5">
      ...
      <div className="pointer-events-none absolute inset-0 select-none opacity-[0.04] overflow-hidden max-w-full">
        ...
        >
          ...
          <path
            d="M200 300q50-80 130-80t130 80"
            stroke="#B08D57"
            strokeWidth="2"
            fill="none"
          />
          <path
            d="M800 200q60-100 160-100t160 100"
            stroke="#B08D57"
            strokeWidth="2"
            fill="none"
          />
      ...
      <div className="pointer-events-none absolute bottom-0 left-0 right-0 select-none opacity-[0.03] overflow-hidden max-w-full">
        ...
        >
          <path
            d="M0 120V60Q180 0 360 40t360-20 360 30 360-10v80H0z"
            fill="#1E3A34"
          />
        </svg>
      </div>
      ...
      <div className="relative mx-auto flex max-w-[90dvw] flex-col md:flex-row">
        ...
        >
          ...
          >
            Five minutes from Anjuna Beach. A private standalone home surrounded
