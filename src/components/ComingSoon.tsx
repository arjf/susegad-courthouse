    ...
    <div className="relative flex min-h-dvh flex-col bg-secondary text-primary overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-2xl flex-1 flex-col items-center justify-center px-6 py-16 text-center">
        ...
        <motion.h1
          ...
          className="mt-6 font-heading text-5xl font-bold tracking-tight text-primary md:text-7xl"
        >
          {siteConfig.name}
        </motion.h1>
        ...
        <motion.div
          ...
          className="mt-6 h-0.5 w-16 origin-center bg-accent1"
        />
        ...
        <motion.p
          ...
          className="mt-6 font-heading text-2xl italic text-accent1 md:text-3xl"
        >
          {siteConfig.tagline}
        </motion.p>
        ...
        <motion.p
          ...
          className="mt-4 max-w-md font-body text-base leading-relaxed text-primary/60"
        >
        ...
        <motion.div
          ...
          className="mt-10 flex flex-wrap items-center justify-center gap-6 text-sm text-primary/50"
        >
          <a
